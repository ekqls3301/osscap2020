...
region_choice = str(input("region choice: "))



today_file = 'koreaData_'+ region_choice +'_'+ a + '.js'
yesterday_file = 'koreaData_' + region_choice +'_'+ b + '.js'

def run():
    data = compare_data(today_file, yesterday_file)
    # print(confirmed_region)
    save_dir = 'cmp_koreaData_'+ region_choice+'_new.js'
    crawler_name = 'cmp_crawlKoreaData_'+region_choice+'.py'
    var_name = 'cmp_koreaData_'+ region_choice
